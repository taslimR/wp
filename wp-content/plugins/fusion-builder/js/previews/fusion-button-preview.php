<?php
$size  = strtolower( FusionBuilder::get_theme_option( 'button_size' ) );
$shape = strtolower( FusionBuilder::get_theme_option( 'button_shape' ) );
$type  = strtolower( FusionBuilder::get_theme_option( 'button_type' ) );
...
if ( class_exists( 'Avada' ) ) {
	...
	function color_needs_adjustment( $color ) {
		if ( '#ffffff' === $color || 'transparent' === $color || '0' === Avada_Color::new_color( $color )->alpha ) {
			return true;
		}
	...
	$gradient_top = color_needs_adjustment( FusionBuilder::get_theme_option( 'button_gradient_top_color' ) ) ? '#f8f8f8' : FusionBuilder::get_theme_option( 'button_gradient_top_color' );
	$gradient_bottom = color_needs_adjustment( FusionBuilder::get_theme_option( 'button_gradient_bottom_color' ) ) ? '#f8f8f8' : FusionBuilder::get_theme_option( 'button_gradient_bottom_color' );
	$accent_color = color_needs_adjustment( FusionBuilder::get_theme_option( 'button_accent_color' ) ) ? '#f8f8f8' : FusionBuilder::get_theme_option( 'button_accent_color' );
	$border_width = FusionBuilder::get_theme_option( 'button_border_width' );
}
?>
