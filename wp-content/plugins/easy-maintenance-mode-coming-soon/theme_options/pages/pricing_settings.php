...
<div class="row" style="margin-left:10px;background: #f7f7f7;padding-top: 10px;padding-bottom: 70px;">
	...
	<div class="span6" style="width:85%;margin-top: auto;">
		<h3><?php _e('Pricing','easy-maintenance-mode-coming-soon') ?></h3>
		<p> <?php _e('We have 2 set of licenses','easy-maintenance-mode-coming-soon') ?></p> 
		
	<ul><li><?php printf(__('<strong>Single Site License</strong> - The price of this license is <b>$29</b>. Which allow you to use the Premium plugin on single site.','easy-maintenance-mode-coming-soon')) ?></li> 
		<li><?php printf(__('<strong>Unlimited Site License</strong> - This price of this license is <b>$59</b>. Which allow you to use the plugin on unlimited wordPress websites.','easy-maintenance-mode-coming-soon')) ?>
		</li></ul>
		<p><?php printf(__('Support and Updates will be given for 1 year. <br>If you need updates and support after one year, then simply renew the license. If not, then you may keep using the plugin.','easy-maintenance-mode-coming-soon')) ?></p>
		

<h3><?php _e('How to Purchase','easy-maintenance-mode-coming-soon') ?></h3>
			<p><?php echo sprintf (__("If you are interested then you can buy the plugin <a href = 'http://member.easycomingsoon.com/pricing/' target = '_blank'>here.</a> Once the purchase process gets complete, the license key will be emailed to you. Add and activate this license key in the license option page in the premium version of this plugin. Make sure that you activate this license key in order to enjoy the continue support and plugin updates.","easy-maintenance-mode-coming-soon")); ?></p>

<h3><?php _e('I look Forward to Working with you','easy-maintenance-mode-coming-soon') ?></h3>
			<p><?php _e('Thousands of users have enjoyed using our. I hope you will also enjoy working with us','easy-maintenance-mode-coming-soon') ?></p>
