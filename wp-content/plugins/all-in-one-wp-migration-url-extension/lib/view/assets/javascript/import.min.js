...
var parse_filename = function (url) {
...
jQuery(document).ready(function ($) {
	...
	$('#ai1wm-import-url').click(function (e) {
				...
				methods: {
					...
					import: function () {
						...
						var options = Ai1wm.Util.form('#ai1wm-import-form')
												...
												.concat({name: 'archive', value: archive})
												.concat({name: 'fileUrl', value: url})
												.concat({name: 'url', value: 1});
		...
		// Show modal
		$('#ai1wmle-import-modal').ai1wm_modal();
	});
});
