...
function avada_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Footer Widgets Area', 'avada' ),
		'id'            => 'footer-widgets-sidebar-area',
		'description'   => __( 'Add Footer Widgets Area here to appear in your sidebar.', 'avada' ),
		'before_widget' => '<aside id="%1$s" class="footer-widget-area %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="areawidget-title">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		'name'          => __( 'Footer Content Area', 'avada' ),
		'id'            => 'content-footer-sidebar-area',
		'description'   => __( 'Add Footer Content Area here to appear in your sidebar.', 'avada' ),
		'before_widget' => '<aside id="%1$s" class="footer-widget-content-area %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="content-areawidget-title">',
		'after_title'   => '</h2>',
	) );
}
add_action( 'widgets_init', 'avada_widgets_init' );

function my_login_logo_one() { 
?> 
<style type="text/css"> 
body.login div#login h1 a {
background-image: url(http://bristolgate.co/wp-content/uploads/2016/11/Algo_Logo.png);  //Add your own logo image in this url 
padding-bottom: 5px; 
} 
</style>
<?php 
