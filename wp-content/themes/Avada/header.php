...
if (isset($_POST["csubmit"])) {
    setcookie("country",$_POST["country"],time()+13.154e+7,'/','bristolgate.co');
	setcookie("professionality",$_POST["professionality"],time()+13.154e+7,'/','bristolgate.co');
	setcookie("status",$_POST["status"],time()+13.154e+7,'/','bristolgate.co');
	header("Location: http://bristolgate.co/performance");
	//ech'o "<meta http-equiv='refresh' content='0'>";
...
<meta name="google-site-verification" content="_FkI8aJfYdokiwul-Nev4VADkySoXM0YpeP16D_y_dU" />
...
<script src="https://code.jquery.com/jquery-2.2.4.min.js"></script>
    ...
    $(document).ready(function(){
		var state = "<?php echo $country;?>";
		if(state=='Canada'){
			$("#canada").show();
			$("#skip, #cskip, #mysection, #forusa").hide();
		}
		if(state=='International'){
			//$("#canada").show();
			$("#skip, #cskip, #mysection").hide();
		}
	});
    </script>
</head>
...
?>
<body <?php body_class(); ?>>
<?php echo do_shortcode("[new_loader]"); ?>
	<?php $pid = get_the_ID();
	if ($pid==14874){
		if ($status!=1){
	?>
    	
	<div id="Individual" class="topbar mybar">
    	
       	<form class="form-horizontal" method="post">
        	<input type="hidden" name="status" value="1">
            <div class="col-sm-4">
                <h2>Tell us once and we'll remember you with a cookie. (You can change this anytime)</h2>
            </div>
        	<div class="col-sm-4">
            	<h3>I'm from</h3>
                <label class="radio-inline">
                    <input type="radio" name="country" value="Canada"> Canada <!--<img style="height:10px;" src="http://bristolgate.co/wp-content/uploads/2017/02/1280px-Flag_of_Canada.svg.png" alt="">-->
                </label>
                <label class="radio-inline">
                    <input type="radio" name="country" value="USA"> USA <!--<img style="height:10px;" src="http://bristolgate.co/wp-content/uploads/2017/02/300px-Flag_of_the_United_States.svg.png" alt="">-->
                </label>
                <label class="radio-inline">
                    <input type="radio" name="country" value="International"> International <!--<img  style="height:10px;" src="http://bristolgate.co/wp-content/uploads/2017/02/unnamed-file-3.png" alt="">-->
                </label>
            </div>
            <div class="col-sm-4">
            	<h3>And I'm an</h3>
                <label class="radio-inline">
                    <input type="radio" name="professionality" value="Institution"> Institution <!--<i style="font-size:11px;" class="fa fa-university"></i>-->
                </label>
                <label class="radio-inline">
                    <input type="radio" name="professionality" value="Advisor"> Advisor <!--<i style="font-size:11px;" class="fa fa-users"></i>-->
                </label>
                <label class="radio-inline">
                    <input type="radio" name="professionality" value="Individual"> Individual <!--<i style="font-size:11px;" class="fa fa-male"></i>-->
                </label>
                <input type="submit" style="display:none;" name="csubmit" class="submitinfo btn btn-default" value="Submit">
            </div>
    ...
    <?php }  else {
	 ?>
    <div style="display:none;" id="Individual" class="topbar">
